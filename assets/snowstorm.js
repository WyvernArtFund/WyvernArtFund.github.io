...
var snowStorm = (function(window, document) {
    ...
    this.flakesMaxActive = 73;      // Limit amount of snow falling at once (less = lower CPU use)
    this.animationInterval = 100;    // Theoretical "miliseconds per frame" measurement. 20 = fast + smooth, but high CPU use. 50 = more conservative, but slower
    this.useGPU = true;             // Enable transform-based hardware acceleration, reduce CPU load.
    this.className = null;          // CSS class name for further customization on snow elements
    this.flakeBottom = null;        // Integer for Y axis snow limit, 0 or null for "full-screen" snow effect
    this.followMouse = true;        // Snow movement can respond to the user's mouse
    this.snowColor = "#fff";        // Don't eat (or use?) blue snow.
    ...
    this.zIndex = 3;                // CSS stacking order applied to each snowflake
